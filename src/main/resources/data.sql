...
VALUES(21, 2, '236W 1st St','Curry Lane','Beverly Hills', 'California', '230089', 'Sale','beautiful mansion by the sea',43000000, 'mansion', 180056.92,10, 13, true, 'open parking space', 6, 'wood', '1990-10-01', true, '1990-10-01', '1990-10-01' );

INSERT INTO PROPERTY(id, user_id, street_address, address2, city, state, zipcode, listing_type, description, price, home_type, sq_ft, bedrooms, bathrooms, pool, parking_type, parking_spaces, floor_type, year_built, is_built_complete, listed_at, deleted_at )
VALUES(22, 2, '2316N 1st St','KKK Lane','Beverly Hills', 'California', '230089', 'Sale','beautiful mansion by the sea',12000000, 'mansion', 81056.09,8, 9.5, true, 'open parking space', 3, 'wood', '1990-10-01', true, '1990-10-01', '1990-10-01');
...
VALUES (1, 21, 'Rent' , 'unemployment', 300, 'Rejected', '1990-10-01', '1990-10-01', '2021-10-01', '1990-10-01' );

INSERT INTO APPLICATION (id,property_id, application_type, employment_info, credit_score, review_status, dropped_at, created_at, reviewed_at, deleted_at)
VALUES (2, 22, 'Buy' , 'employment', 700, 'Approved', '1990-10-01', '1990-10-01', '1990-10-01', '1990-10-01' );
